 ...
 * @param clientFactory kinesis client factory
  ...
  override def onStart() {
    ...
    val kinesisClientLibConfiguration =
      new KinesisClientLibConfiguration( checkpointAppName,
                                         streamName,
                                         clientFactory.getCredentialsProvider,
                                         workerId )
      .withKinesisEndpoint( clientFactory.endpointURL )
    ...
    */
    ...
    worker = new Worker.Builder()
             ...
             .kinesisClient(clientFactory.getKinesisClient)
             .build()
